...
| 0.45             | 91.09403255    | 88.85714286    | 102.1030741    |

![Evaporation](Evaporation.png)

Тренд по evaporation-rate:
При низькому evaporation-rate (0.05) залишок їжі найменший, особливо в першій купі - це означає, що мурахи швидко формують стабільні маршрути і ефективно збирають їжу.
Зі збільшенням evaporation-rate до 0.35–0.45 кількість залишеної їжі зростає, але не критично.

При великому evaporation-rate (0.45) залишок їжі у першій та другій купі суттєво зростає, що свідчить про слабку стабільну трасу і менш ефективний збір.
...
Найефективніше збирання їжі спостерігається при evaporation-rate = 0.05.
Надто швидке випаровування (0.5) знижує ефективність збору.
...
Змінний параметр: diffusion-rate = 0.1, 0.3, 0.5 , 0.7, 0.9.
Фіксовані: population = 20, evaporation-rate = 0.05
Тривалість: 500 ticks
| Diffusion rate | Food in pile 1 | Food in pile 2 | Food in pile 3 |
|----------------|----------------|----------------|----------------|
| 0.1            | 90.16141002    | 96.75695733    | 95.80519481    |
| 0.3            | 88.66415094    | 94.00377358    | 99.16226415    |
| 0.5            | 84.99629630    | 85.29444444    | 94.23888889    |
| 0.7            | 82.87612208    | 91.17594255    | 95.65529623    |
| 0.9            | 82.75091575    | 98.78571429    | 92.58974359    |
