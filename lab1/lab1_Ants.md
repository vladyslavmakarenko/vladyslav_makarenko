...
При середній популяції (40) споживання помітно прискорюється.
При великій популяції (80) — найефективніше: значення найнижчі для всіх трьох купок.
...
При кількості мурах = 80 різниця між купками вирівнюється, бо велика кількість мурах підтримує стабільні феромонні траєкторії навіть на великий відстані.

3. Загальна тенденція
Колонія мурах демонструє нелінійну продуктивність:
перехід від 10 → 20 мурах дає невелике покращення;
від 20 до 40 - значне;
від 40 до 80 - найсуттєвіше прискорення збору.
...
Змінний параметр: evaporation-rate = 0.01, 0.05, 0.1, 0.2
...
Змінний параметр: diffusion-rate = 0.1, 0.5, 1, 2
